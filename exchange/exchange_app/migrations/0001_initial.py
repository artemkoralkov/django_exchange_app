...
def create_exchange_tables(apps, schema_editor):
    with connection.cursor() as cursor:
        cursor.execute("""
            ...
            amount_in_cash NUMBER(15, 2) DEFAULT 0.00
            )
        """)
        cursor.execute("""
            INSERT INTO cash_reserves (currency_id, currency_name, amount_in_cash)
            VALUES (0, 'Белорусский рубль', 1000000); 
                """)
        cursor.execute("""
            CREATE TABLE exchange_rates (
                ...
                rate_date DATE NOT NULL DEFAULT SYSDATE ,
        ...
        cursor.execute("""
            ...
            BEGIN
                IF :NEW.currency_from_id != 0 THEN
